...
internal class HealthComponent : MonoBehaviour, IInitializeComponent
{
    ...
    #region Il2Cpp .ctor
    static HealthComponent() => ClassInjector.RegisterTypeInIl2Cpp<HealthComponent>();

    public HealthComponent() : base(ClassInjector.DerivedConstructorPointer<HealthComponent>()) => ClassInjector.DerivedConstructorBody(this);
    ...
    public void SubstractHealth(int amount)
    {
        ...
        {
            EnemyCharacterComponent enemyComponent = gameObject.GetComponentWithCast<EnemyCharacterComponent>();
